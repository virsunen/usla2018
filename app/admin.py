...
SiteSettings, SiteMemberProfile, NewsItem2, EventGallery, EventGalleryImages, FrontPageLinks, MembershipSettings, CalendarHolidays
...
class NewsItemAdmin(SiteMemberAdmin):
    ...
    def render_change_form(self, request, context, *args, **kwargs):
        ...
        return super(NewsItem2, self).render_change_form(request, context, args, kwargs) 
