# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-06-07 02:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_tel', models.CharField(blank=True, max_length=16, null=True, validators=[django.core.validators.RegexValidator(message=b'Phone number invalid.', regex=b'^\\+?1?[\\d-]{9,18}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to=app.models.get_upload_usla_membership_images)),
